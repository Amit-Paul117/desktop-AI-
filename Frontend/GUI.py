...
old_chat_message = rf"{current_dir}\Frontend\Files"
...
def QueryModifier(Answer):
    new_query = Answer.lower().strip()
...
class ChatSection(QWidget):
    def __init__(self):
        ...
        # use Qt.NoTextInteraction (you had QFrame.NoFrame)
        ...
        self.timer.start(200)  # avoid super-tight loop

        self.chat_text_edit.viewport().installEventFilter(self)

        # scrollbar styling (QScrollBar selector)
        self.setStyleSheet("""
            QScrollBar:vertical {
                border: none;
                background: black; width: 10px;
    ...
    # (These icon helpers are kept; only corrected usage)
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        self.toggled = True
        self.icon_label.mousePressEvent = self.toggle_icon  # click to toggle
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        minimize_icon = QIcon(GraphDirectoryPath('Minimize.png'))
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        stacked_widget.setCurrentIndex(0)  # **Ensure the first page is visible**
        ...
        self.setCentralWidget(stacked_widget)  # **Set this as the central widget**
...
def GraphicalUserInterface():
    ...
    window = MainWindow()
    window.setWindowIcon(QIcon(GraphDirectoryPath("AppIcon.png")))
    window.show()
    sys.exit(app.exec_())
